#!/usr/bin/env python3
"""
K-Means File Clustering and Archiving Script

This script clusters files using k-means based on file characteristics
...
class FileClusterer:
    ...
    def cluster_files(self):
        ...
        self.clusters = kmeans.fit_predict(features_normalized)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Cluster files using k-means and create compressed archives",
