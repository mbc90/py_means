#!/usr/bin/env python3
"""
Gaussian Mixture Models (GMM) and K-Means File Clustering and Archiving Script

This script clusters files using GMM or K-means based on file characteristics
...
class FileClusterer:
    ...
    def __init__(
        ...
        Args:
            ...
            algorithm: Wheter to use K-means or GMM
    ...
    def cluster_files(self):
        ...
        self.clusters = model.fit_predict(features_normalized)
